...
from apps.api.deps import (
    get_ai_market_service, get_bar_repo, get_chip_service, get_fund_flow_service,
    get_kline_service, get_market_query_service, get_notification_service,
    get_quote_cache, get_redis_cache, get_registry, get_signal_scan_service,
